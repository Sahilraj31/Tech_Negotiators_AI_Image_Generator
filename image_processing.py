...
def parse_simple_prompt(prompt):
    ...
    objects = [
        ...
        "cricketer", "virat kohli", "ronaldo", "Mr bean", "sahil"
    ...
    locations = [
        ...
        "arena", "gym", "fitness", "yard", "countryside", "woods", "jungle", "tress", "tress branch", "nest",
        "rainfall","cricket staium", "football staium", "disneyland"
    ]
